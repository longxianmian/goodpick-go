...
import { Calendar, FileText, GraduationCap, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen p-4 pb-20">
      <div className="w-full max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">{t('staffCampaign.description')}</p>
        </div>
              ...
              return (
                <Card key={campaign.id} data-testid={`campaign-${campaign.id}`}>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {/* Expandable Details */}
                    {(campaign.staffInstructions || campaign.staffTraining) && (
                      <>
                        <Button
                          variant="outline"
                          className="w-full"
